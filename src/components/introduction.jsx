                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1>Min interesse for mennesket, virksomheder før system <br /> er en del af min natur.</h1>
                ...
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1>En virksomhedskonsulent med højt drive og energi som tager ansvar, <br /> deltager i teamet med smittende humør som styrker </h1>
